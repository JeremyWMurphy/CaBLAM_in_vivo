...
const uint32_t sampsPerSecond = 5000; // temporal resolution of timer units in seconds * 1/ sampsPerSecond
...
const uint8_t dOutPins[] = {32,2,3,4,5,6};  //these are indexed with dOutNum and reward rolled in at ind 0
